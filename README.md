...
## Current complexity
Our performance and complexity are state of the art right now. As close to linear complexity as humanly possible in 2026. We achieve maximum performance while keeping precission 100% (0% degradation).
